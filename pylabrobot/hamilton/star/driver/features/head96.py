...
class Head96(Head):
  ...
  async def _aspirate(
    ...
    """Draw on every channel in place, every field checked; the firmware moves Z and piston together.
  ...
  async def _dispense(
    ...
    """Expel on every channel in place, every field checked; the firmware moves Z and piston together.
