...
class Pipettes:
  ...
  async def _probe_batch_liquid_heights(
    ...
    *,
    ...
    The channels stand at the batch's X/Y. Each round they go to their starts together, then seek down
    to the cavity bottom and stay where they detect: together with a second session, one after the
    other without it.
