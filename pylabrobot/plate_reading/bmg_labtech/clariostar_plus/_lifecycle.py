"""CLARIOstar Plus lifecycle mixin: constructor, I/O, status, device info, temp, filters."""
...
class _LifecycleMixin:
  """Constructor, setup/stop, I/O, status, device info, drawer, temperature, filters, counters."""
  ...
  def __init__(
    ...
    Args:
      ...
      measurement_poll_interval: Seconds to sleep between measurement polling
        ...
        yields ~285 ms per poll cycle, matching the OEM software software cadence
  ...
  # Defined on the mixin class so methods can access it via self._STATUS_FRAME.
  # (The main CLARIOstarPlusBackend class inherits this through MRO.)
