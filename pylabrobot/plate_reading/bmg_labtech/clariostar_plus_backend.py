...
class CLARIOstarPlusBackend(PlateReaderBackend):
  ...
  async def setup(self) -> None:
    ...
    # CMD_0x0E: observed in every OEM MARS pcap (both normal boot and recovery
  ...
  async def auto_focus(
    ...
    *,
    ...
    # ``busy`` flag (not ``running``), matching the OEM MARS behaviour observed
    # in pcap F-Q01: MARS polls STATUS_QUERY until busy clears (~28 s).
